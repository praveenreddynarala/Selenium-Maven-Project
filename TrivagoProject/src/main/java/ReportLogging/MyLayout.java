 ...
 **/
public class MyLayout extends ReportLogging.HTMLLayout {
	...
	/** The timestamp format. The format can be overriden by including the following 
	  ...
	  *
	  **/
	private String timestampFormat = "yyyy.MMM.dd  zzz hh:mm:ss.SSS a ";//"yyyy-MM-dd-HH:mm:ss.SZ"; // Default format. Example: 2008-11-21-18:35:21.472-0800
